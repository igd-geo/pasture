...
pub struct AttributeRange1<'a, T: PrimitiveType> {
    raw_data: &'a [u8],
    offset: usize,
    stride: usize,
    length: usize,
...
impl<'a, T: PrimitiveType> AttributeRange1<'a, T> {
    ...
    pub fn at(&self, index: usize) -> T {
        ...
        unsafe {
            let mut point_raw_data = std::slice::from_raw_parts_mut(
...
pub struct AttributeIter1<'a, T: PrimitiveType> {
    attribute_range: AttributeRange1<'a, T>,
    head: usize,
    tail: usize,
}

impl<'a, T: PrimitiveType> Iterator for AttributeIter1<'a, T> {
    type Item = T;
...
impl<'a, T: PrimitiveType> ExactSizeIterator for AttributeIter1<'a, T> {}

impl<'a, T: PrimitiveType> DoubleEndedIterator for AttributeIter1<'a, T> {
...
impl<'a, T: PrimitiveType> IntoIterator for AttributeRange1<'a, T> {
    type Item = T;
    type IntoIter = AttributeIter1<'a, T>;
...
pub struct AttributeParIter1<'a, T: PrimitiveType + Send> {
    attribute_range: AttributeRange1<'a, T>,
}

impl<'a, T: PrimitiveType + Send> ParallelIterator for AttributeParIter1<'a, T> {
    type Item = T;
...
impl<'a, T: PrimitiveType + Send> IndexedParallelIterator for AttributeParIter1<'a, T> {
    fn len(&self) -> usize {
