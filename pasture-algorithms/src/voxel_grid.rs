...
fn centroid_average_vec<T: BorrowedBuffer>(
    ...
    for p in &v.points {
        match point_type {
            ...
            PointAttributeDataType::VEC3I8 => {
                let vec = buffer
                    .view_attribute::<Vector3<i8>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
            ...
            PointAttributeDataType::VEC3I16 => {
                let vec = buffer
                    .view_attribute::<Vector3<i16>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
            }
            PointAttributeDataType::VEC3U32 => {
                let vec = buffer
                    .view_attribute::<Vector3<u32>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
            ...
            PointAttributeDataType::VEC3I32 => {
                let vec = buffer
                    .view_attribute::<Vector3<i32>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
            }
            PointAttributeDataType::VEC3U64 => {
                let vec = buffer
                    .view_attribute::<Vector3<u64>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
            }
            PointAttributeDataType::VEC3I64 => {
                let vec = buffer
                    .view_attribute::<Vector3<i64>>(attribute_definition)
                    .at(*p);
                x_sum += vec.x as f64;
                y_sum += vec.y as f64;
                z_sum += vec.z as f64;
...
fn centroid_average_num<PB: BorrowedBuffer>(
    ...
    for p in &v.points {
        match point_type {
            ...
            _ => unimplemented!("For vector types use centroid_average_vec."),
        }
    }
